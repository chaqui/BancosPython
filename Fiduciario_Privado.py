...
class Fiduciario_Privado(CreditoFiduciario):
    ...
    def guardar(self):
        try:
            archivo=open("Archivos/Fiduciario_Privado.txt","a")
        except:
            archivo=open("Archivos/Fiduciario_Privado.txt","w")
        ...
        def imprimir_web(self):
            html=self.leerplantilla("hml/Privado.html")
            diccionario=dict(
            ...
            self.guardar(html,"html imprimir/Fiduciario_Privado.html")
